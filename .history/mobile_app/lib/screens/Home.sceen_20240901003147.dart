...
class _HeroPagesState extends State<HeroPages> {
  final _infos = [
    ...
    },
    {
      ...
      'title': 'djdfjdhjhsdlfdsfl',
      'image':
          'https://www.google.com/url?sa=i&url=https%3A%2F%2Fblog-fr.orson.io%2Fweb-design%2Fjpeg-ou-png&psig=AOvVaw3Ye-dI3IK4HyfJu9QeNRGQ&ust=1725206136182000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCNjIouvLn4gDFQAAAAAdAAAAABAR'
    },
  ];
  ...
  void initState() {
    ...
    //   int nextPage = (_currentinfo) % _images.length;
